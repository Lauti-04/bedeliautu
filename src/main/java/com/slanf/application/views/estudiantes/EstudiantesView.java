package com.slanf.application.views.estudiantes;

import com.slanf.application.data.SamplePerson;
import com.slanf.application.services.SamplePersonService;
...
public class EstudiantesView extends Div implements BeforeEnterObserver {
    ...
    public EstudiantesView(SamplePersonService samplePersonService) {
        this.samplePersonService = samplePersonService;
        addClassNames("estudiantes-view");
